...
class _AutomationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.primary, width: AppResponsive.w(1)),
      ),
      child: Column(
        children: [
          Padding(
                ...
                if (isLive)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(AppResponsive.r(15)),
                    ),
                    child: Text(
                      'Live',
                      style: AppTextStyles.caption.copyWith(
          ...
          if (showExtraStats) const _ExtraStatsRow(),
          ...
          Container(
            ...
            decoration: const BoxDecoration(color: Color(0xFFFAF7FF)),
            child: Row(
              children: List.generate(stats.length, (index) {
                final stat = stats[index];

                return Expanded(child: _StatItem(data: stat));
              }),
            ),
          ),
  ...
  Widget _buildLeading() {
    if (imagePath != null) {
      return ClipRRect(
        borderRadius: BorderRadius.circular(AppResponsive.r(7)),
        child: Image.asset(
          imagePath!,
